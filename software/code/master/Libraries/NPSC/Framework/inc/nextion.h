 ...
 * @{
 */
#define NEXTION_PERIPH_USART			RCC_APB1Periph_USART2
#define NEXTION_PERIPH_GPIO				RCC_AHB1Periph_GPIOA
#define NEXTION_PERIPH_DMA				RCC_AHB1ENR_DMA1EN
#define NEXTION_GPIO					GPIOA
...
#define NEXTION_USART					USART2
#define NEXTION_USART_IRQ				USART2_IRQn
#define NEXTION_BAUDRATE				9600
#define NEXTION_DMA						DMA1
#define NEXTION_DMA_CHANNEL				DMA_Channel_4
#define NEXTION_DMA_STREAM			 	DMA1_Stream5
#define NEXTION_DMA_STREAM_IRQ			DMA1_Stream5_IRQn
